  ...
  return (
    <div className="pt-24 pb-20 px-4 max-w-4xl mx-auto">
      ...
      <div className="space-y-6">
        <AnimatedSection delay={0.1} className="bg-white rounded-xl p-8 border border-[#e5e4e2] shadow-sm">
        ...
        <AnimatedSection delay={0.2} className="bg-white rounded-xl p-8 border border-[#e5e4e2] shadow-sm">
        ...
        <AnimatedSection delay={0.3} className="bg-white rounded-xl p-8 border border-[#e5e4e2] shadow-sm">
